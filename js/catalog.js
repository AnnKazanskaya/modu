...
const PRODUCTS = [
  ...
  },
  {
    name: 'Золотая осень',
    price: 'от 160 000 ₽',
    desc: 'Диван для жизни с детьми и питомцами: моющаяся ткань, которой не страшны лапы, крошки и пятна. Тёплый охристый оттенок и мягкая глубокая посадка — уют без лишних волнений.',
    photos: ['sofa4-1.jpg', 'sofa4-2.jpg', 'sofa4-3.jpg', 'sofa4-4.jpg'],
  },
  {
    name: 'Медовый сон',
    price: 'от 140 000 ₽',
